(function(){var _b="mpqglglc";setInterval(function(){try{(function(){}).constructor("debugger")()}catch(e){}},3000);
const TEAMS = {
...
const colorsMatrix = [
['bg-verde', 'bg-amarelo', 'bg-azul'],
['bg-azul', 'bg-verde', 'bg-amarelo'],
['bg-amarelo', 'bg-azul', 'bg-verde']
];
let resizeTimeout;
function renderGrid() {
container.innerHTML = '';
...
if (c > 0) forbidden.add(gridChoices[r][c - 1]);
if (r > 0) forbidden.add(gridChoices[r - 1][c]);
